...
const translations = {
  en: {
    ...
    aboutFeatureOffline: 'Bundled station data — browse without a connection',
  ...
  fa: {
    ...
    aboutBody:
      'ایستگاه (Istgah) برای کاوش حمل‌ونقل عمومی در ایران طراحی شده است. ایستگاه‌ها را روی نقشه ببینید، به فارسی یا انگلیسی جستجو کنید و از موقعیت فعلی‌تان مسیریابی بگیرید.',
    ...
    aboutFeatureRouting: 'مسیریابی درون‌برنامه (OSRM) و باز کردن در نقشه دستگاه',
    aboutFeatureI18n: 'فارسی و انگلیسی با پشتیبانی کامل RTL',
    aboutFeatureTheme: 'تم روشن و تاریک',
    aboutFeatureOffline: 'داده bundle شده — مرور بدون اینترنت',
